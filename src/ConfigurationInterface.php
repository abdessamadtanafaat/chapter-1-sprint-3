...
interface ConfigurationInterface
{
     ...
     * @throws UnknownOptionException if hte the requested key does not exist or is malformed
     */
     ...
     *
     * @return ValidationException if the schema failed to validate the given input
     */
